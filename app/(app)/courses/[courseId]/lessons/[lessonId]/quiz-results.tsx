...
import type { QuizAttempt, QuizReviewRow } from "@/lib/types";
            ...
            <dl className="mt-3 space-y-1.5 text-sm">
              ...
              {!row.is_correct && (
                <div className="flex gap-2">
                  ...
                  <dd className="text-ink">{row.correct_labels.join(", ")}</dd>
                </div>
              )}
            </dl>
